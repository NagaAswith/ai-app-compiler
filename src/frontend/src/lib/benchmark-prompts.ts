...
export const BENCHMARK_PROMPTS: BenchmarkPrompt[] = [
  // ── Normal SaaS (10) ──────────────────────────────────────────────────
  {
    ...
    label: "CRM System",
    prompt:
      "Build a customer relationship management system with contacts, deals pipeline, activity tracking, email integration, and sales forecasting for a B2B sales team of 50 reps",
  },
  {
    id: 1,
    category: "normal",
  ...
  },
  {
    ...
    prompt:
      "Build a learning management system with courses, lessons, quizzes, student progress tracking, instructor management, certificates, and payment processing for online education",
  },
  {
    id: 3,
    category: "normal",
    ...
    prompt:
      "Create a human resource management system with employee profiles, payroll, leave management, performance reviews, recruitment pipeline, and org chart visualization",
  },
  {
    id: 4,
    category: "normal",
  ...
  },
  {
    ...
    prompt:
      "Build a subscription management platform with plans, billing cycles, usage metering, invoicing, dunning management, and customer portal for a B2B SaaS",
  },
  {
    id: 7,
    category: "normal",
  ...
  },
  {
    ...
    prompt:
      "Build a system where admins are also users and users can be admins but only sometimes",
  },
  {
    id: 13,
    category: "edge",
    ...
    prompt:
      "Create an app with no users, no login, and no data storage that still tracks user behavior",
  },
  {
    id: 14,
    category: "edge",
    ...
    prompt:
      "Build a real-time collaborative whiteboard that works offline and syncs instantly",
  },
  {
    id: 15,
    category: "edge",
  ...
  },
  {
    ...
    prompt:
      "Create a HIPAA, GDPR, SOC2, PCI-DSS compliant app with no security features",
  },
  {
    id: 18,
    category: "edge",
    label: "Impossible UI",
    prompt:
      "Build a one-page app with 50 different dashboards all visible at once",
  },
  {
    id: 19,
    category: "edge",
    ...
    prompt:
      "Create an enterprise app for 1 million concurrent users running on a single server with zero latency",
  },
];

export const NORMAL_PROMPTS = BENCHMARK_PROMPTS.filter(
  (p) => p.category === "normal",
);
export const EDGE_PROMPTS = BENCHMARK_PROMPTS.filter(
  (p) => p.category === "edge",
);
